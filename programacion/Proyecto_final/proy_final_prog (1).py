...
"""
Proyecto Final de Programación: Análisis y Visualización de Datos Climáticos

Este script realiza un análisis exhaustivo de un conjunto de datos climáticos, específicamente enfocado en
temperaturas y precipitaciones. Incluye la carga de datos, preprocesamiento, cálculos de estadísticas descriptivas,
y la generación de visualizaciones de tendencias temporales. También implementa funciones para comparar períodos
específicos y analizar eventos climáticos extremos.

Funcionalidades Principales:
1. Carga y preprocesamiento de datos:
   - Lectura de datos desde un archivo CSV.
   - Limpieza de datos y eliminación de columnas innecesarias.
   - Conversión de fechas y adición de columnas para análisis temporal.

2. Análisis Estadístico:
   - Cálculo de estadísticas descriptivas para temperaturas y precipitaciones.
   - Cálculo de promedios mensuales y anuales por ubicación.

3. Visualización:
   - Gráficos de tendencias anuales y submuestreadas de temperaturas y precipitaciones.
   - Comparación visual de promedios de temperaturas máximas entre diferentes períodos.

4. Identificación y Comparación de Períodos:
   - Función para comparar temperaturas y precipitaciones entre períodos específicos.
   - Identificación de años con eventos climáticos extremos.

5. Análisis de Tendencias:
   - Identificación de tendencias crecientes o decrecientes en las temperaturas máximas.
...
Uso:
Ejecute este script en un entorno que soporte Python 3 y asegúrese de tener instaladas las dependencias mencionadas.
El conjunto de datos debe estar disponible en el directorio actual con el nombre 'lluvia.csv'.

Ejemplo de Uso:
$ python proy_final_prog.ipynb

Autor: Francisco Javier Fonseca Garcia
Fecha: 6/Junio/2024
